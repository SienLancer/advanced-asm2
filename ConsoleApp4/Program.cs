...
namespace ConsoleApp4
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Laptop l1 = new Laptop(0, "OMEN HP 15", "HP", 1500, "Gaming");
            Laptop l2 = new Laptop(1, "DELL-G3", "DELL", 2100, "Office");
            ...
            Component c1 = new Component(0, "Ram Kingston v5", "Kingston", 5678, "Ram", "8gb bus 2400hz");
            componentStorage.GetComponents().Add(c1);
            Component c2 = new Component(1, "Ram Kingston g4", "Kingston", 500, "Ram", "4GB ddr4");
            componentStorage.GetComponents().Add(c2);
            Component c3 = new Component(2, "Ram Kingston g8", "Kingston", 800, "Ram", "8GB ddr4");
            componentStorage.GetComponents().Add(c3);
            ComponentImport cI1 = new ComponentImport(0, DateTime.ParseExact("01/11/2022", format, provider), 6, c1);
            componentImportList.ComponentImportList.Add(cI1);
            ComponentImport cI2 = new ComponentImport(1, DateTime.ParseExact("04/10/2022", format, provider), 4, c2);
            componentImportList.ComponentImportList.Add(cI2);
            ComponentImport cI3 = new ComponentImport(2, DateTime.ParseExact("27/07/2022", format, provider), 7, c3);
